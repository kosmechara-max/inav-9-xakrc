...
// Кастомна модифікація під датчик LSM6DXX літака XAKRC
#define USE_GYRO_LSM6DXX
#define USE_ACC_LSM6DXX
#define GYRO_LSM6DXX_ALIGN      CW270_DEG
#define ACC_LSM6DXX_ALIGN       CW270_DEG
#define GYRO_1_CS_PIN           PA4
#define ACC_1_CS_PIN            PA4
#define GYRO_LSM6DXX_SPI_BUS    BUS_SPI1
#define ACC_LSM6DXX_SPI_BUS     BUS_SPI1
